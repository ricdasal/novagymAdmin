...
urlpatterns = [
    ...
    path('membresias/usuarios/<int:pk>/', membresia_listar_usuario, name='listar_usuario'),
    ...
    path('membresias/beneficios/',
         ListarBeneficio.as_view(), name='listar_beneficio'),
    path('membresias/beneficios/agregar/',
         CrearBeneficio.as_view(), name='agregar_beneficio'),
    path('membresias/beneficios/editar/<int:pk>/',
         EditarBeneficio.as_view(), name='editar_beneficio'),
]
